...
in the cloud and fog concepts. In Section~\ref{sec:sol_smart_warehouse_deployment}, we present a
conceptual architecture of the smart warehouse based on the fog and cloud deployment approaches.\\
...
allow us to have more flexibility in the provisioning of smart place applications. That flexibility
will allow to later compare the performance of both approaches.
