...
and fog through a \gls{ADSL} connection with a bandwidth \ldots.\\
...
\textit{Response} stages presents similar results, respectively close to $\approx10\%$ and $\approx11\%$.
