...
the new infrastructure adopt a decentralized architecture where the EPCIS is deployed in the
...
features such as application isolation and multi-tenancy.\\
...
in Figure~\cite{bonomi2012fog} the distributed infrastructure of Fog is composed of heterogeneous
...
\section{Internet of Things application domains characteristics}
