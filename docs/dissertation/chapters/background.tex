...
tool is responsible to enforce that state. For instance, \gls{CM} tools allows to automate the
...
between these tools is that some of the them are oriented to developers, which is the case of Chef and
Puppet that requires some programming experience to be used, while others are oriented to system
